...
//////////////////////////////// EXPERIMENTAL
var edButtonsD = new Array();

function edButtonD(id, display, tagStart, tagEnd, access, open) {
	this.id = id;				// used to name the toolbar button
	this.display = display;		// label on button
	this.tagStart = tagStart; 	// open tag
	this.tagEnd = tagEnd;		// close tag
...
//var customButton['highlight'] = new Array("<span class='highlight'>", "</span>");
function customTag(myField, tag)
{
	//IE support
	if (document.selection) {
		myField.focus();
		...
		if (sel.text.length > 0) {
			...
			//if (!edCheckOpenTags(i) || edButtons[i].tagEnd == '') {
				//sel.text = edButtonsD[i].tagStart;
				sel.text =  "<" + tag + ">"
				//edAddTag(i);
			//}
			//else {
				//sel.text = edButtonsD[i].tagEnd;
				sel.text =  "<" + tag + ">";
				//edRemoveTag(i);
			//}
		}
	...
	else if (myField.selectionStart || myField.selectionStart == '0') 
	{
		...
		// customButton[i] = new Array("<span class='highlight'>", "</span>");
		if (startPos != endPos) 
		{
			...
			cursorPos += eustomButton[tag][0].length + ustomButton[tag][0].length;
		}
		else 
		{
			//if (!edCheckOpenTags(i) || edButtons[i].tagEnd == '') {
				myField.value = myField.value.substring(0, startPos) 
					//+ edButtonsD[i].tagStart
					+ "<" + tag + ">"
					//+ edButtonsD[i].tagEnd
					+ "</" + tag + ">"
					+ myField.value.substring(endPos, myField.value.length);
				//edAddTag(i);
				//cursorPos = startPos + edButtonsD[i].tagStart.length;
			//}
			//else {
				//myField.value = myField.value.substring(0, startPos) 
				              //+ edButtons[i].tagEnd
		...
		//if (!edCheckOpenTags(i) || edButtons[i].tagEnd == '') {
			//myField.value += edButtonsD[i].tagStart;
			myField.value += "<" + tag + ">";
			//myField.value += edButtonsD[i].tagEnd;
			myField.value += "</" + tag + ">";
			//edAddTag(i);
		//}
		//else {
...
function standardTag(myField, tag) 
{
	//IE support
	if (document.selection) {
		myField.focus();
	...
	else if (myField.selectionStart || myField.selectionStart == '0') 
	{
		...
		if (startPos != endPos) 
		{
			...
			var tmp1 = "<" + tag + ">";
			var tmp2 = "</" + tag + ">";
			cursorPos += tmp2.length + tmp2.length;
		}
		else 
		{
			//if (!edCheckOpenTags(i) || edButtons[i].tagEnd == '') {
